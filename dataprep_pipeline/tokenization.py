...
class TokenizerPipeline:
    ...
    def tokenize_data(self, corpus):
        encoded_texts_longest = self.tokenizer(
            corpus["qna"], max_length=self.max_len, truncation=True
        )
    ...
    def run(self): 
        ...
        tokenized_corpus = corpus_dataset.map(
            self.tokenize_data, batched=True, batch_size=1, drop_last_batch=True
        )
...
if __name__ == "__main__":
    ...
    file_path = "dataprep_pipeline/data/dataset_train.csv"
